...
# Additional plots can be added as required like total value and action counts
[23/10, 7:49 pm] Naman IiitV-icd: import numpy as np
import matplotlib.pyplot as plt
...
# Additional plots can be added for total value and action counts if needed